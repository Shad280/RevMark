...
Run in production as a one-off command (example: via Railway run or `python migrate_add_escrow_columns.py` with DATABASE_URL set).
"""
import os
import sys
...
def add_escrow_columns():
    ...
    with app.app_context():
        ...
        # Define the columns we expect and the SQL to add them (Postgres)
        actions = [
